...
# PATCH_SIZE=8
# TARGET_DATA='cifar10'
# RESUME_DIR='search-'${TARGET_DATA}'_pt_search_v1cls_maskr'${RATIO}'p'${PATCH_SIZE}${TARGET_DATA}'seed'${SEED}'-s5-seed'${SEED}

# WDIR=/data/gbc/Workspace/pt
# PYTHONHOME=/root/miniconda3/envs/rookie/bin
